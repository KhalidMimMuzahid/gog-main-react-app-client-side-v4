...
const JobRole = () => {
  return (
      <div className='my-10 p-10'>
          ...
          <div className="my-10 flex flex-col md:flex-row justify-center items-center gap-6 md:gap-[187px]">
          ...
          <div className='flex flex-col md:flex-row items-center justify-center gap-6 md:gap-[187px]'>
