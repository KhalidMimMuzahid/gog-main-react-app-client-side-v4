  ...
  return (
    <div className="mt-[80px]">
      ...
      <div className="flex flex-row gap-[1px]">
        <button className="bg-[#D1FFD0]">Full Stack Web Development</button>
        <button className="bg-[#D1FFD0]">Full Stack Data Scientist</button>
      </div>
      ...
      <div className="grid md:grid-cols-2  gap-10 grid-cols-1">
        ...
        <div className="mt-[24px] order-1 md:order-2 h-[360px] bg-[#D1FFD0] rounded-[40px] py-[30px]  pl-[30px] ">
          Card Element
        </div>
      </div>
    </div>
