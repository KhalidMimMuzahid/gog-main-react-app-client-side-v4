...
const TrustedCompany = () => {
  ...
  return (
    <div className="mb-[80px]">
          <h5 className="text-center text-[25px] md:text-[36px] font-semibold text-transparent bg-clip-text text-gradient bg-gradient-to-r from-[#4BA25D] via-[#3DA5BD] to-[#905BEC]">Trusted by 500+ companies</h5>
