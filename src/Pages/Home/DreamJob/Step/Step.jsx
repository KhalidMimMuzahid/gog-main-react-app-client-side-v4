...
const Step = ({ defaultThumb, step, index, setJobStatus, jobStatus }) => {
  return (
    <li
      ...
      className={`hover:cursor-pointer hover:shadow-lg hover:shadow-[#37ED81]/20  md:p-[20px] p-[12px] md:my-[40px] my-[20px] hover:border hover:bg-[#F8FFF9] dark:hover:bg-[#191C1E] rounded-[20px] ${
