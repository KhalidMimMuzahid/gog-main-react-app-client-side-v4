      ...
      <div className="md:p-[40px] p-[30px]">
          ...
          <div className="flex flex-col gap-3 text-sm md:text-base">
            ...
            <div className="flex items-center gap-6">
              ...
              <p className="flex gap-3 md:gap-10 items-center">
                <span className="relative">
                  <span className="invisible hidden sm:inline-block">Class Timings</span>
        ...
        <div className="flex justify-between text-sm md:text-base flex-wrap gap-5">
          <div className="flex gap-5">
            <img src={Clock} alt="clock image" />
            <div>
              <p className="text-[#101010] dark:text-white">
                Hurry up
              </p>{" "}
              <p className="text-[#4BA25D] font-medium">
                Limited Seat
              </p>
            </div>
          </div>
          <div className="flex w-full md:w-auto justify-center gap-5">
            <div className="">
              <button
                type="button"
                className="py-2 px-4 border border-[#101010] dark:border-white rounded-full"
              >
                Know More
              </button>
            </div>
            <div className="float-right">
              <button
                type="button"
                className="py-2 px-4 border border-[#00A3FF] rounded-full bg-[#00A3FF] text-white"
              >
                Apply Now
              </button>
            </div>
