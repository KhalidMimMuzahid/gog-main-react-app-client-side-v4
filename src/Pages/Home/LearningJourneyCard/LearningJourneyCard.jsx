...
function LearningJourneyCard() {
  return (
    <div className="relative rounded-3xl my-[70px] mx-[30px] md:mx-[65px] p-10 lg:p-16 text-[#101010] dark:text-white bg-white shadow-md shadow-[#19B85140] dark:bg-[#1C202A] dark:shadow-none">
      <img
        src={star}
