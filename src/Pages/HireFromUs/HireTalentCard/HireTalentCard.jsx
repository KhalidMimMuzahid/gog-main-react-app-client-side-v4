...
function HireTalentCard() {
  return (
    <div className="p-[20px] sm:p-[30px] md:p-[40px] bg-gradient-to-r from-[#D1FFD0] to-[#BBE7FF] dark:from-[#1C202A] dark:to-[#1C202A] mt-[80px] rounded-3xl text-center md:text-left">
